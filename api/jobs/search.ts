...
Ensure all entries are high fidelity and represent genuine, actual listings.`;
      ...
      console.warn("Gemini Live Search failed. Using high-fidelity Fallback job matching strategy.", geminiError);
